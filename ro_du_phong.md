...
|---|---|---|---|---|
| **DPM** | 4/9 | **Hội tụ đủ 3 cửa — mã mạnh nhất đợt quét.** LNST 239→233→411→**916** (x3,8). Biên gộp bật 19-20-17→**24%**. CFO **+788**. ROE 15,3 · PE 8,76 · PB 1,37 · nợ 0,60x. Giá trên cả MA20 (22,1) lẫn MA50 (22,6), vol **x1,69**. | **≤ 22.100** (về MA20) · vào 2 nhịp · nhịp 2 nếu ≤ 21.000 | 🆕 **5/9: DPM nằm trong 21 mã bị loại khỏi FTSE Vietnam Index — nhưng là NHIỄU, không phải lực bán.** DPM không thuộc FTSE Vietnam 30 (rổ Fubon) và **không** nằm trong 27 mã vào FTSE All-Cap ⇒ không có dòng passive nào phải bán. Nếu tít "bị loại" dìm giá về ≤22.100 thì đó là **dip do nhãn**, đúng loại dip cần. **Ngoại mua +1,45tr cp/20p nhưng +1,42tr dồn vào 5 phiên cuối** = đang tăng tốc. Rủi ro: đã chạy, mua đuổi ở 22,9k là trả giá đỉnh nhịp. |
...
| **VRE** | 4/9 | Biên gộp **tăng đều cả 4 quý: 51→52→55→59%**. Nợ **0,27x** — sạch nhất nhóm. CFO **+1.820** với CFI +106 / CFF −6 → gần như tự nuôi hoàn toàn. ROE 15,5 · PE 8,27 · PB 1,22. | **≤ 25.300** (MA20) | 🆕 **5/9: VRE cũng trong 21 mã bị loại khỏi FTSE Vietnam Index, nhưng CÓ trong 27 mã vào FTSE All-Cap** ⇒ hai chiều bù nhau, net mỏng. **Ngoại đảo chiều: 20p −4,55tr → 5p +2,37tr.** Giá trên cả 2 MA, vol x1,28. Máy chấm SKIP — tôi không theo, vì máy không đọc đạo hàm biên gộp. Đang ở watch tier universe từ 11/8. |
...
| **SSI** | 4/9 | **Đầu ngành chứng khoán về chất.** LNST ổn định nhất ngành 1.480/820/1.280/1.230. Biên gộp 51→72→**73%**. PE 10,96 < ngành 14,63; PB 1,30 < 1,55. Nợ 1,37x thuộc nhóm thấp. **CFO −2.790 là đặc thù margin bơm ra, KHÔNG phải kiệt quệ** (Q4/25 +12.386 = thu hồi margin; Q1–Q2/26 âm = bơm lại). | **A. Breakout:** đóng cửa **> 22.300** (MA20) + vol ≥ median (~21,5tr cp) + ngoại mua ròng ≥3 phiên liên tiếp<br>**B. Gom dip:** **19.400–20.000** (đáy 52w) mà ngoại ngừng bán | ROE 13,9% **trượt bộ lọc máy** (<15%) — nhưng ROE ngành CK chỉ 12,9%, SSI vượt ngành. Đây là ca bộ lọc tuyệt đối đọc sai (xem HẠN CHẾ #1).<br>❌ **Mốc phủ định:** đóng cửa thủng **19.400** → gỡ khỏi watchlist.<br>📅 **Mốc canh (cập nhật 5/9):** ~~7/9 FTSE chốt danh sách~~ → **FTSE đã công bố 4/9** · **18/9** ATC / **21/9** hiệu lực **đợt 1 chỉ 10%** · **sau 22/9** đọc filing kết quả GD ông Nguyễn Hồng Nam.<br>🆕 **5/9 — SSI bị loại khỏi FTSE Vietnam Index** (1 trong 21 mã). **Nhưng rổ đó gần như rỗng tiền:** quỹ bám chính là Xtrackers FTSE Vietnam Swap (~331tr EUR) **đã đổi benchmark sang STOXX Vietnam Total Market Liquid** và đổi tên; Fubon (~356tr USD) bám **FTSE Vietnam 30**, không phải rổ này. Cùng ngày 21/9 SSI lại **VÀO** FTSE All-Cap (small cap, đợt 1 chỉ 10%). ⇒ **Net flow mỏng cả hai chiều — tin chỉ số KHÔNG thay trigger giá.**<br>⚠️ SSI vào **FTSE All-Cap nhóm SMALL CAP**, **KHÔNG** vào All-World (chỉ 6 mã: VCB/VIC/VHM/BID/HPG/VPB) → rổ mỏng tiền hơn nhiều. Room ngoại 1,75 tỷ cp là **KHÔNG LIÊN QUAN** (cần ~9.900 phiên để lấp) — đừng dựng luận điểm trên room (lỗi #16). |
...
- 🆕 **5/9 — số thật lớn hơn nhiều so với ghi chú cũ.** BCTC bán niên SAU SOÁT XÉT: dự phòng **3.684 tỷ** (1.416,8 tỷ giảm giá tồn kho + **2.267,3 tỷ tổn thất chính sách thu đổi hàng ĐÃ BÁN, có hàng bán từ hơn 7 năm trước**), LNST bán niên **728,5 tỷ** (−38% so báo cáo tự lập). Con số **865 tỷ** trong sổ lỗi #11 là dự phòng Q2 tự lập — **đã lạc hậu**.
- 🆕 **Truy một tầng cái nhãn "gia đình Chủ tịch bơm tiền cứu công ty":** đây là **CHO VAY**, không phải góp vốn/mua cổ phần. Nguồn tiền = **bán 25 triệu cp PNJ**. Ròng lại: gia đình **giảm sở hữu cổ phần (chịu rủi ro sau cùng)** và **đổi sang tư cách CHỦ NỢ (được trả trước cổ đông)**. Áp lỗi #13 — hành động này **giảm rủi ro cho người làm**, nên **không đọc thành conviction**. Thêm: ĐHĐCĐ **bất thường** đã có nghị quyết tổ chức (3/9).
- 📄 Chuỗi đầy đủ: **`pnj_watch.md`**.
